...
local function teleportUntilAllCriminalHRPsLoaded()
    ...
    -- Configuration
    local SCAN_HEIGHT = 50  -- Optimal height to avoid obstacles
    local SCAN_WAIT = 0.01   -- Fast scanning interval
    local MIN_DISTANCE = 400 -- Minimum distance between scan points
...
local function serverHop()
    ...
    local success, err = pcall(function()
        ...
        queue_on_teleport([[loadstring(game:HttpGet("https://raw.githubusercontent.com/MashXBox1/Mansion-Sniper/refs/heads/main/testarrest4.lua"))()]])
        task.wait(0.5)
